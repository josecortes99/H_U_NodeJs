...
//import { ProductsDTO } from "../dtos/products.dto.ts";
...
router.post("/", authMiddleware, authorizeRoles(["admin", "vendedor"]), /*validateDto(ProductsDTO),*/ createProductController);
router.put("/:id", authMiddleware, authorizeRoles(["admin", "vendedor"]), /*validateDto(ProductsDTO),*/ updateProductController);
